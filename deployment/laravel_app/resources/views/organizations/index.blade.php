...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0">
                <i class="bi bi-building text-primary"></i> إدارة الجهات
            </h4>
            <a href="{{ route('organizations.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> إضافة جهة جديدة
            </a>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <i class="bi bi-list-ul"></i> الجهات ({{ $organizations->total() }})
            </div>
            <div class="card-body p-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('organizations.destroy', $org->id) }}" method="POST"
                                                class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه الجهة؟')">
                                                @csrf
                                                @method('DELETE')
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3">لا توجد جهات مسجلة</p>
                        <a href="{{ route('organizations.create') }}" class="btn btn-primary">
                            <i class="bi bi-plus-circle"></i> إضافة جهة جديدة
                        </a>
                    </div>
